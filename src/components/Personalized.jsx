    ...
    <section className={`${styles.sectionBox} bg-darkBlue overflow-hidden`}>
        ...
        <div className={`${styles.contentBox} px-4 pb-[64px] relative`}>
            ...
            <div className={`${styles.h2Box} pb-[80px]`}>
                ...
                whileInView="visible"
                viewport={{once: true, amount: 1}}
                className={`${styles.h2} text-center text-white pt-[32px]`}>A personalized experience, <span className='text-blue'>for everyone</span> on your tour.</motion.h2>
                <div>
                    <motion.p 
                    variants={fadeUp2}
                    initial="hidden"
                    whileInView="visible"
                    viewport={{once: true, amount: 1}}
                    className={` text-white ${styles.h2Body}`}>Manage your entire team from one place, even if they’re split across different cities.  Your experience is the command center, their’s is only what they need.</motion.p>
                </div>
            </div>
