...
const Reviews = () => {
  ...
  const setCurrIndex = (currSlide) => {
    // Delay setting the current slide index to ensure the correct index is set
  ...
  const reviewData = [
    ...
    },
    {
      ...
      image: avatar,
      name: "John Doe",
      title: "Tour Manager - Billie Eillish" 
    },
    {
      id: 2,
      ...
      image: avatar,
      name: "John Doe",
      title: "Tour Manager - X Amabassadors" 
    },
    {
      id: 3,
      review: `I'm loving Daysheets! It's fast, and simple.`,
  ...
  <div className={`${styles.sectionBox} bg-blue relative`}>
    ...
    <Carousel
      ...
      beforeChange={(nextSlide) => {
        setCurrentSlide((nextSlide + reviewData.length - 2) % reviewData.length);
      }}
    >
      {review}
    </Carousel>
    ...
    <img src={gradient} alt="Gradient background" className='absolute top-0 left-0 z-0 w-full h-full object-cover opacity-25' />
